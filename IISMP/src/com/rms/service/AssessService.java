...
public interface AssessService {
	 ...
	 * @return List<Assess>
	 */
	public abstract List<Assess> findassesspingguxinxibyid(int ac_id);
	 ...
	 * @return boolean
	 */
	public abstract boolean isnotExitforAssess(int id, int m_id, int m_id2);
	 ...
	 * @return List<AssessChart>
	 */
	public abstract List<AssessChart> findassesschart();
