...
List<Resource_Type> rt=(List<Resource_Type>)request.getAttribute("Resource_Type");
	   ...
	   <div class="row clearfix">
				...
				<div class="col-md-9 column" style="-webkit-box-shadow: inset 0 0 6px rgba(0,0,0,0.3);border:#EDEFF0 solid;border-width:5px; background-color: #FFFFFF;">
					<h4 style="margin-top:10px;">
						...
						<span id="rtid" style="display: none"><%=rtt.getRt_id() %></span>
									...
									<th>
										<div class="col-lg-6">
							                <div class="input-group">
							                    <input type="text" class="form-control input-sm" maxlength="2" id="yeshu" style="width: 45">
